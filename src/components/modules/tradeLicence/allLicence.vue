      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-info">
            ...
            <h4 class="card-title"> {{credentials['union']}} ইউনিয়ন পরিষদ এর ট্রেডলাইসেন্স সমূহ</h4>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-md-3">
                  ...
                  <tr>
                    <td>
                      <div class="col-md-12"  style="text-align:center">
                         <br>
                        <h5>{{credentials['union']}} ইউনিয়ন পরিষদ এর ট্রেডলাইসেন্স সমূহ  <span v-if="(credentials['bazar'])">, বাজারঃ {{credentials['bazar']}} </span></h5>
...
export default {
  ...
  methods: {
    ...
    async holdings(page = 1){
      this.loading=true;
      this.form.page = page
      TradeLicenceService.index(this.form).then(response=>{
