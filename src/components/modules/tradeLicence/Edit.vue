            ...
            <div class="card-title">
              ...
              <div class="pull-right">
                <router-link
                  ...
                  ><i class="fa fa-list"></i> সকল ট্রেড লাইসেন্স
                </router-link>
              </div>
            </div>
              ...
              <div class="row">
                ...
                <div class="form-group col-md-3">
                  ...
                  <input
                    ...
                    :class="{
                      'form-control': true,
                      'text-danger': errors.has('trade_licence_no')
                    }"
                  />
                  <span
                    v-show="errors.has('trade_licence_no')"
                    class="help text-danger"
                    >{{ errors.first("trade_licence_no") }}</span
                  >
                  <span
                    v-if="validateErrors.trade_licence_no"
                    class="help text-danger"
                ...
                <div class="form-group col-md-3">
                  ...
                  <input
                    ...
                    :class="{
                      'form-control': true,
                      'text-danger': errors.has('holding_no')
                    }"
                  />
                  <span
                    v-show="errors.has('holding_no')"
                    class="help text-danger"
                    >{{ errors.first("holding_no") }}</span
                  >
                  <span
                    v-if="validateErrors.holding_no"
                    class="help text-danger"
                    >{{ validateErrors.holding_no[0] }}</span
                  >
                </div>
              </div>
              <div class="row">
                <div class="form-group col-md-3">
                  <label for="organization_name"
                    ><span> প্রতিষ্ঠানের নাম</span></label
                  >
                  <input
                    type="text"
                    ...
                    :class="{
                      'form-control': true,
                      'text-danger': errors.has('organization_name')
                    }"
                  />
                  <span
                    v-show="errors.has('organization_name')"
                    class="help text-danger"
                    >{{ errors.first("organization_name") }}</span
                  >
                  <span
                    v-if="validateErrors.organization_name"
                    class="help text-danger"
                ...
                <div class="form-group col-md-3">
                  ...
                  <input
                    ...
                    id="owner_name"
                    placeholder="প্রোপাইটরের নাম"
                    v-validate="'required'"
                    :class="{
                      'form-control': true,
                      'text-danger': errors.has('owner_name')
                    }"
                  />
                  <span
                    v-show="errors.has('owner_name')"
                    class="help text-danger"
                    >{{ errors.first("owner_name") }}</span
                  >
                  <span
                    v-if="validateErrors.owner_name"
                    class="help text-danger"
                    >{{ validateErrors.owner_name[0] }}</span
                  >
                </div>
                <div class="form-group col-md-3">
                  ...
                  >
                  <span v-if="validateErrors.mobile" class="help text-danger">{{
                    validateErrors.mobile[0]
                  }}</span>
                </div>
                ...
                <div class="form-group col-md-3">
                  ...
                  <input
                    type="text"
                    required
                    v-model="form.father_or_husband"
                    name="father_or_husband"
                    id="father_or_husband"
                    placeholder="বাবা/স্বামী"
                    v-validate="'required'"
                    :class="{
                      'form-control': true,
                      'text-danger': errors.has('father_or_husband')
                    }"
                  />
                  <span
                    v-show="errors.has('father_or_husband')"
                    class="help text-danger"
                    >{{ errors.first("father_or_husband") }}</span
                  >
                  <span
                    v-if="validateErrors.father_or_husband"
                    class="help text-danger"
