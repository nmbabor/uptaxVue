      ...
      this.$validator.validateAll()
        .then((resp) => {
          if (!resp) {
            ...
            let month = new Date(this.form.start_date).getMonth() + 1
            if (month < 10) {
              month = '0' + month
            }
            if (day < 10) {
            ...
            // Birthdate format
            let birthDay = new Date(this.form.birth_date).getDate()
            let birthMonth = new Date(this.form.birth_date).getMonth() + 1
            if (birthMonth < 10) {
            ...
            let birthYear = new Date(this.form.birth_date).getFullYear()
            this.form.birth_date = birthYear + '-' + birthMonth + '-' + birthDay;
        ...
        <div class="card">
          <div class="card-body">
            <div class="card-title"> নতুন ট্রেড লাইসেন্সের তথ্য সংযোজন
              <div class="pull-right">
                <router-link tag="a" to="/trade-licence" class="btn btn-xs btn-light waves-effect waves-light m-1"><i
                    class="fa fa-list"></i> সকল ট্রেড লাইসেন্স </router-link>
              </div>
            </div>
            <hr>
            <form method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <button type="button" @click="validateBeforeSubmit" class="btn btn-light px-5"><i class="fa fa-save"></i>
                  সাবমিট </button>
              </div>
            </form>
          </div>
