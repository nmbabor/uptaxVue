            ...
            <div class="col-lg-12">
                ...
                <div class="row" v-if="form.type!=3">
                  <div class="form-group col-md-3">
                      ...
                      <input type="number" min="0" name="house_unripe" v-model="form.house_unripe" id="house_unripe" placeholder="কাঁচা ঘরের সংখ্যা" class="form-control">
                  </div>
                  <div class="form-group col-md-3">
                  ...
                  <div class="form-group col-md-3">
                      ...
                      <input type="number" min="0" name="house_bhite_paka" v-model="form.house_bhite_paka" id="house_bhite_paka" placeholder="ভিটে পাকা ঘরের সংখ্যা" class="form-control">
                  </div>
                  <div class="form-group col-md-3">
                      <label for="house_semi_ripe">বাড়ির ধরণ (আধা পাকা ঘর)</label>
                      <input type="number" min="0" name="house_semi_ripe" v-model="form.house_semi_ripe" id="house_semi_ripe" placeholder="আধা পাকা ঘরের সংখ্যা" class="form-control">
                  </div>
                  <div class="form-group col-md-3">
                      <label for="house_ripe">বাড়ির ধরণ (পাকা ঘর)</label>
                      <input type="number" min="0" name="house_ripe" v-model="form.house_ripe" id="house_ripe" placeholder="পাকা ঘরের সংখ্যা" class="form-control">
                  </div>
