              ...
              <div v-if="loading" class="col-md-12" style="text-align:center;position:absolute;background: rgb(30, 71, 108,.8);z-index:9;padding:100px;left:0;height:85%">
                ...
                <form method="POST" @submit.prevent="discountSubmit" enctype="multipart/form-data" v-if="discount.status==1">
                  ...
                  <div class="col-md-12 main-table">
                    ...
                    <small> <span>{{en2bn(holding.year_name)}}</span> (<span v-if="holding.type==1">আবাসিক</span> <span v-else-if="holding.type==2">বানিজ্যিক</span> <span v-else>সকল</span>) </small></h6>
                ...
                <form method="POST" @submit.prevent="validateBeforeSubmit" enctype="multipart/form-data" v-if="discount.status==0">
                    <div class="row">
                      <div class="col-md-4">
