      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <form method="POST" @submit.prevent="validateBeforeSubmit" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <div class="col-md-12 no-padding">
                      <input type="text" name="chairman_name" v-model="form.chairman_name" v-validate="'required'"
                        :class="{ 'form-control': true, 'text-danger': errors.has('chairman_name') }">
                      <span v-show="errors.has('chairman_name')" class="help text-danger">{{ errors.first('chairman_name')
                      }}</span>
                      <span v-if="validateErrors.chairman_name" class="help text-danger">{{ validateErrors.chairman_name[0]
                      }}</span>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <div class="col-md-12 no-padding">
                      <input type="number" name="chairman_mobile" min="0" v-model="form.chairman_mobile"
                        v-validate="'required'"
                        :class="{ 'form-control': true, 'text-danger': errors.has('chairman_mobile') }">
                      <span v-show="errors.has('chairman_mobile')" class="help text-danger">{{
                        errors.first('chairman_mobile') }}</span>
                      <span v-if="validateErrors.chairman_mobile"
                        class="help text-danger">{{ validateErrors.chairman_mobile[0] }}</span>
              ...
              <div class="row">
                <div class="form-group col-md-4">
                  ...
                  <input type="text" name="email" v-model="form.email" id="email" placeholder="ইমেইল"
                    :class="{ 'form-control': true, 'text-danger': errors.has('email') }">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input type="text" name="bank_name" v-model="form.bank_name" id="bank_name" placeholder="ব্যাংকের নাম"
                    :class="{ 'form-control': true, 'text-danger': errors.has('bank_name') }">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input type="text" name="branch_name" v-model="form.branch_name" id="branch_name"
                    placeholder="ব্রাঞ্চের নাম"
                    :class="{ 'form-control': true, 'text-danger': errors.has('branch_name') }">
                  <span v-show="errors.has('branch_name')" class="help text-danger">{{ errors.first('branch_name')
                  }}</span>
                  <span v-if="validateErrors.branch_name" class="help text-danger">{{ validateErrors.branch_name[0]
                  }}</span>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <div class="col-md-12 no-padding">
                      <input type="text" name="secretary_name" v-model="form.secretary_name" v-validate="'required'"
                        :class="{ 'form-control': true, 'text-danger': errors.has('secretary_name') }">
                      <span v-show="errors.has('secretary_name')" class="help text-danger">{{
                        errors.first('secretary_name') }}</span>
                      <span v-if="validateErrors.secretary_name"
                        class="help text-danger">{{ validateErrors.secretary_name[0] }}</span>
                    </div>
                  </div>
                </div>
                <div class="form-group col-md-4">
                  <label for="input-2"> বিল শুরু তারিখ </label>
                  <vuejs-datepicker type="date" format="dd-MM-yyyy"
                    :input-class="{ 'form-control': true, 'text-danger': errors.has('bill_start_date') }"
                    v-validate="'required'" name="bill_start_date" v-model="form.bill_start_date"
                    placeholder=" বিল শুরু তারিখ"></vuejs-datepicker>
                  <span v-show="errors.has('bill_start_date')" class="help text-danger">{{ errors.first('bill_start_date')
                  }}</span>
                  <span v-if="validateErrors.bill_start_date" class="help text-danger">{{ validateErrors.bill_start_date[0]
                  }}</span>
                </div>
                <div class="form-group col-md-4">
                  <label for="input-2"> বিল শেষ তারিখ </label>
                  <vuejs-datepicker type="date" format="dd-MM-yyyy"
                    :input-class="{ 'form-control': true, 'text-danger': errors.has('bill_end_date') }"
                    v-validate="'required'" name="bill_end_date" v-model="form.bill_end_date"
                    placeholder="বিল শেষ তারিখ"></vuejs-datepicker>
                  <span v-show="errors.has('bill_end_date')" class="help text-danger">{{ errors.first('bill_end_date')
                  }}</span>
                  <span v-if="validateErrors.bill_end_date" class="help text-danger">{{ validateErrors.bill_start_date[0]
                  }}</span>
                </div>
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="details" v-model="form.details" id="details" placeholder="সৌজন্যে"
                    :class="{ 'form-control': true, 'text-danger': errors.has('details') }">
                ...
                <div class="form-group col-md-3">
                  <label for="trade_license_prefix"> জেলা, উপজেলা, উনিয়ন কোড (ট্রেড লাইসেন্স কোড) </label>
                  ...
                  <span v-if="validateErrors.trade_license_prefix" class="help text-danger">{{ validateErrors.trade_license_prefix[0] }}</span>
                </div>
              </div>
              <div class="row">
                <div class="col-md-3">
            ...
            <div class="form-group">
              <button type="submit" @click="validateBeforeSubmit" class="btn btn-light px-5"><i class="fa fa-save"></i>
                সাবমিট </button>
            </div>
          </form>
        </div>
