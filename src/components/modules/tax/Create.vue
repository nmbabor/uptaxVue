                      ...
                      <div class="col-md-6">
                        ...
                        <div class="table-responsive">
                          <table class="table table-bordered">
                            ...
                            <tr>
                              <td>ধরণ</td>
                              <td><span v-if="form.type==1">আবাসিক</span> <span v-else-if="form.type==2"> বানিজ্যিক</span></td>
                            </tr>
                            <tr>
                      ...
                      <div class="col-md-6" style="background: rgba(0,0,0,.2);padding:10px">
                        ...
                        <div class="table-responsive">
                          <table class="table table-striped">
                            ...
                            <tr>
                              <td colspan="2" class="no-border"><button type="submit" class="btn btn-primary px-5 pull-right"><i class="fa fa-save"></i> ট্যাক্স সাবমিট </button></td>
                            </tr>
