      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-info">
            ...
            <h4 class="card-title"> {{credentials['union']}} ইউনিয়ন পরিষদ কর আদায়ের রেজিষ্টার প্রতিবেদন</h4>
          </div>
          <div class="card-body">
            <div class="row">
                  ...
                  <tr>
                    <td>
                      <div class="col-md-12"  style="text-align:center">
                         <br>
                        <h5>{{credentials['union']}} ইউনিয়ন পরিষদ কর আদায়ের রেজিষ্টার প্রতিবেদন, <span v-if="credentials['village']"> {{credentials['village']}}, </span> <span v-if="(credentials['word'])"> {{credentials['word']}} নং ওয়ার্ড, </span> <span v-if="(credentials['year'])"> {{credentials['year']}}</span>({{credentials['type']}})</h5>
                      </div>
                    </td>
                  </tr>
                </thead>
                ...
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <tr v-for="data in allHoldings.data" :key="data.id">
                      ...
                      <td> {{data.mobile}} </td>
                      <td> {{data.word}} </td>
                      <td style="white-space: normal;"> {{data.village_name}} </td>
                    ...
                    <tr style="background:#999">
                      ...
                      <th>{{this.footer.tax}}</th>
                      <th>{{this.footer.prev_paid}}</th>
    ...
    dataDistribute(){
      this.footer = {
        ...
        for(let i = 0;i<this.allData.length;i++){
          ...
          this.footer.tax += parseFloat(this.allData[i].tax)
