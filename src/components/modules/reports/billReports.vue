      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div id="printMe" class="raw bill-print" style="font-size:80%;min-width:612px;overflow:hidden">
            
            <div class="row" v-for="holding in holdingsData" :key="holding.id" :data-id="holding.index" :class="[holding.index%2==0?'break-page':'']" style="padding:5px;overflow:hidden;height:790px;background:#fff;margin-bottom:20px;" >
             <div class="col-md-6" style="width:50%;float:left;border-right:1px dotted #333;padding-right:2%">
              ...
              <table class="table table-bordered table-striped bill-table" >
                  ...
                  <tr v-if="holding.type==3">
                    <th style="background:#e7f9f7 !important"> ব্যবসার ধরণ <b>:</b> </th>
                    <td>{{holding.business_type}}</td>
                  </tr>
                  <tr>
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-12" style="overflow:hidden;font-size:90%;">
                  <span style="width:45%;float:left;border-top:1px dotted #333;margin-top:95px;text-align:center">ব্যাংক/ইউপি কার্যালয়ের সিল  </span>
                  <span style="width:40%;float:right;margin-top:15px;text-align:center">
                    ...
                    <br>
                  <span style="border-top:1px dotted #333;padding:1px;">
