      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-info">
            ...
            <h4 class="card-title"> {{credentials['union']}} ইউনিয়ন পরিষদ বকেয়া কর আদায়ের রেজিষ্টার প্রতিবেদন </h4>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-md-2">
                  ...
                  <tr>
                    <td>
                      <div class="col-md-12"  style="text-align:center">
                         <br>
                        <h5>{{credentials['union']}} ইউনিয়ন পরিষদ বকেয়া কর আদায়ের রেজিষ্টার প্রতিবেদন, <span v-if="credentials['village']"> {{credentials['village']}}, </span> <span v-if="(credentials['word'])"> {{credentials['word']}} নং ওয়ার্ড, </span> <span v-if="(credentials['year'])"> {{credentials['year']}}</span>({{credentials['type']}})</h5>
...
export default {
  ...
  methods: {
    ...
    async holdings(page = 1){
      ...
      ReportsService.prevTaxCollection(this.form).then(response=>{
    ...
    dataDistribute(){
      this.footer = {
        ...
        for(let i = 0;i<this.allData.length;i++){
          ...
          this.footer.total_prev_paid += parseFloat(this.allData[i].prev_paid)
