      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-info">
            ...
            <h4 class="card-title"> {{credentials['union']}} ইউনিয়ন পরিষদ বকেয়া প্রতিবেদন </h4>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-md-2">
                  ...
                  <tr>
                    <td>
                      <div class="col-md-12"  style="text-align:center">
                         <br>
                        <h5>{{credentials['union']}} ইউনিয়ন পরিষদ বকেয়া প্রতিবেদন, <span v-if="credentials['village']"> {{credentials['village']}}, </span> <span v-if="(credentials['word'])"> {{credentials['word']}} নং ওয়ার্ড, </span> <span v-if="(credentials['year'])"> {{credentials['year']}}</span>({{credentials['type']}})</h5>
                ...
                <table class="table table-bordered table-striped">
                  <thead>
                    <tr style="background:#777">
                      ...
                      <th class="no-print"> ডিসকাউন্ট </th>
                    </tr>
                  ...
                  <tbody>
                    <tr v-for="data in allHoldings.data" :key="data.id">
                      ...
                      <td class="no-print">
                       <router-link class="btn btn-xs btn-light waves-effect waves-light m-1" v-bind:to="{ name: 'editHolding', params: { id: data.holding_id }, query: {discount:1} }"> <i class="fa fa-edit"></i></router-link>
                      </td>
                    </tr>
    ...
    dataDistribute(){
      this.footer = {
        ...
        for(let i = 0;i<this.allData.length;i++){
          ...
          this.footer.discount+=parseFloat(this.allData[i].discount)
